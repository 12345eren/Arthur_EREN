...
module.exports = {
  ...
  ownername: process.env.OWNER_NAME === undefined ? '*𝑬𝑹𝑰𝑵 ❄️&𝑨𝑹𝑻𝑯𝑼𝑹' : process.env.OWNER_NAME,
  sessionName:  process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID,
  author:  process.env.PACK_INFO.split(";")[0] === undefined ? '*┃⚡️┃┊ 𝑨𝑹𝑻𝑯𝑼𝑹✓┃⚡️┃┊*' : process.env.PACK_INFO.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS === undefined ? false : process.env.AUTO_READ_STATUS,
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? '𝑬𝑹𝑰𝑵 ❄️&𝑨𝑹𝑻𝑯𝑼𝑹 👑' : process.env.PACK_INFO.split(";")[1],
